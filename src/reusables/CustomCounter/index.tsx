...
const CustomCounter = ({ text = "passenger", outlined=false, mb =false }: { text?: string, outlined?: boolean, mb?: boolean}) => {
    ...
    return (
              <div className={`${outlined ? "outlined" : ''} ${mb ? "mb" : ''} custom__counter`}>
