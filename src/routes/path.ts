...
export const APP_ROUTES = {
  ...
  getBookedPage: ({ type, id }: { type: string; id: string }) =>
    `/booked-success/?type=${type}&id=${id}`,
  ...
  profile: "/profile",
  getHelp: "/getHelp",
  getBookingSummaryPrimary: ({ type, id }: { type: string; id: string }) =>
    `/booking-detail/?type=${type}&id=${id}`,
