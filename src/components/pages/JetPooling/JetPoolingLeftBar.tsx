        ...
        <div className="jet-pooling__leftbar">
            ...
            <div className="subscribe">
                <div className="subscribe__header">
                    ...
                    <p>Recieve updates on shared flights going your route, when they are available.</p>
                    <Divider className="custom-divider" />
                    <p>Fill the form below to get updates on your preferred jet pooling routes.</p>
                </div>
