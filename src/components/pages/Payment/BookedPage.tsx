...
import { CustomAlert, OutlineButton, PrimaryButton } from '../../../reusables';
...
const BookedPage = () => {
    ...
    return (
        <article className="payment-method booked-page">
                    ...
                    <div className="need__car--container">
                        <div>
                            ...
                            <div>
                                <h5>Need a car?</h5>
                                <p>
                                    By clicking on “Add car” bossbuss will provide you with a car,
                                    to pick you up from your pick up point to your departure
                                    location.
                                </p>
            ...
            <PickupForm openPickupForm={open} closePickupForm={handleClose} />
        </article>
    );
};
