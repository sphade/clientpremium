...
export const filters = {
    capacity: {
        title: 'Capacity',
        filters: ['2-5 Passengers', '6+ passengers'],
    },
    prices: {
        title: 'Prices',
        filters: ['Less than N45,000', 'N45,000 to N65,000', 'N65,000 to N85,000', 'N85,000 and more'],
    },
    year: {
        title: 'Year',
        filters: ['2015-2016', '2016-2017', '2017-2018', '2018-2019', '2019-2020', '2019-2020'],
    },
}