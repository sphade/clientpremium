...
const Profile = () => {
    ...
    const {open: openPasswordModal, toggleDialog: togglePasswordModal} = useDialogHook();
    const {open: openChangePhotoModal, toggleDialog: toggleChangePhotoModal} = useDialogHook();
