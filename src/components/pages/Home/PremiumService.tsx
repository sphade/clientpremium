...
import ServiceTwoImage from './../../../assets/images/service-2.jpg';
...
const PremiumService = () => {
    return (
        <div className="services jumbotron">
                ...
                <div className="service__card--content pl-100">
                    <div>
                        ...
                        <p>
                            ...
                            felis ut lacinia luctus, nisi nisi gravida ligula, in convallis risus
                            odio non felis. Mauris scelerisque nibh velit.{' '}
                        </p>
            ...
            <div className="service__card">
                <div className="service__card--image">
                    <img src={ServiceTwoImage} alt="service-one" />
                </div>
                <div className="service__card--content pr-100">
                    <div>
                        <h3>JET POOLING</h3>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut cursus,
