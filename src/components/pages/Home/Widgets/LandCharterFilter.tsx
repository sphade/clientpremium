...
import { landCraftType } from '../../AirCharter/constants';
    ...
    return (
        <>
            ...
            <div className="charter__content--form">
                <PrimaryInput name="Leaving" label="Pickup Location" icon={<NavigatorIcon />} />
                <PrimaryInput name="Leaving" label="Charter Duration" icon={<LocationIcon />} />
            </div>
            <div className="charter__content--form">
